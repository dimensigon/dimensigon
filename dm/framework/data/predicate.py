...
>>> from dm.framework.data.predicate import Predicate, where
...
from ..interfaces.dao import IPredicate
from ..utils.collection import freeze, is_iterable
from ..utils.operators import resolve_path, check_path
