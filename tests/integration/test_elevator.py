...
class TestElevator(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.deployable = 'deployable.tar.gz'
        self.version = '1.0'
    ...
    def test_upgrade_error_new_version(self, mock_get_hc, mock_exists, mock_shutil, mock_stop, mock_start, mock_daemon,
        ...
        with patch('elevator.open', m):
            _upgrade(
                dict(deployable=self.deployable, version=self.version, dm_url=f"https://127.0.0.1:{d.LOOPBACK_PORT}"))
        ...
        self.assertListEqual(
            [((self.new_home, logging.root.level != logging.DEBUG),), ((None, logging.root.level != logging.DEBUG),)],
