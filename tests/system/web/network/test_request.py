...
from dm.web.network import request, HTTPBearerAuth, async_request
...
class TestNetwork(TestCase):
    ...
    def test_get_error(self):
        ...
        resp = request('get', Server.get_current(),
    ...
    def test_post(self):
        ...
        resp = request('post', Server.get_current(), 'api_1_0.actiontemplatelist', json=data,
                       auth=self.auth)
    ...
    def test_get_securizer(self):
        ...
        resp = request('get', Server.get_current(), 'api_1_0.actiontemplateresource',
    ...
    def test_async_get_error(self, m):
        ...
        data, status = run(async_request('get', Server.get_current(),
                                         'api_1_0.actiontemplateresource',
                                         view_data=dict(
    ...
    def test_async_post(self, m):
        ...
        data, status = run(
            async_request('post', Server.get_current(), 'api_1_0.actiontemplatelist', json=at_json,
                          auth=self.auth))
    ...
    def test_async_get_securizer(self, m):
        ...
        data, status = run(
            async_request('get', Server.get_current(), 'api_1_0.actiontemplateresource',
                          view_data=dict(action_template_id=self.at_json['id']), auth=self.auth))
