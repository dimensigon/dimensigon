...
class TestUpgradeCatalog(TestCase):
    ...
    def test_upgrade_catalog_server(self):
        ...
        with mock.patch('dm.network.gateway.requests.post') as mocked_post:
            data = encode(function='local_get_delta_catalog', kwargs=dict(data_mark='20190101000530100000'))
    ...
    def test_upgrade_catalog_client(self):
        with mock.patch('dm.network.gateway.requests.post') as mocked_post:
            ...
            repo._repo_classes = {'ActionTemplateRepo': dm.repositories.ActionTemplateRepo,
            ...
            with self.app1.app_context():
                ...
                server = repo.ServerRepo.find(id_='bbbbbbbb-1234-5678-1234-56781234bbb2')
                ...
                action_list = repo.ActionTemplateRepo.all()
                self.assertEqual(4, len(action_list))
                action = repo.ActionTemplateRepo.find(id_='aaaaaaaa-1234-5678-1234-56781234aaa1')
