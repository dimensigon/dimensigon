...
Revision ID: 80760060fd66
Revises: 
Create Date: 2020-04-27 17:39:15.715347
...
def upgrade():
    ...
    op.create_table('D_group',
    sa.Column('last_modified_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.CHAR(), nullable=False),
    sa.Column('group', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_D_group'))
    )
    ...
    sa.Column('scope', sa.Enum('UPGRADE', 'ORCHESTRATION', 'CATALOG', name='scope'), nullable=False),
