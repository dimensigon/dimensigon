from .ai import AI_TOOLS, handle_ai_tool
...
ALL_TOOLS = DISCOVERY_TOOLS + CREATION_TOOLS + EXECUTION_TOOLS + UTILITY_TOOLS + AI_TOOLS
...
TOOL_HANDLERS = {
    ...
    **{t.name: handle_ai_tool for t in AI_TOOLS},
}
